...
\begin{exam}[Presence]{Presence}
  ...
  \begin{instructions}[Obtaining the exercise repository]
    ...
    from eCampus as a \texttt{physics718\_exercises\_ex01.zip} archive. To unpack it,
    you can use your file manager or the \bash{unzip} command in the linux/Mac
    terminal.
  \end{instructions}
  ...
  \begin{instructions}[Getting familiar with the development environment]
    ...
    \begin{problem*}\textbf{Command line basics and simple control flow}
      ...
      \item Instead of the basic Python interpreter, for interactive work it
        ...
        auto-completion and help. Run \bash{ipython}. To print 100
        ...
        the modulo operator \py{%}. Try out how the operator works
          ...
          \item  When given an argument, the \texttt{python} command can be used to run
            Python programs. Run \bash{python zen.py} to be enlightened.
          \end{parts}
        \end{problem*}
    ...
    \begin{exam}[Homework]{Homework}
      ...
      \end{problem*}
        ...
        \notebox{
          \textbf{Submission deadline:} One week after your exercise, on the day when the
          exercise would be if the exercises weren't bi-weekly.
        }
    \end{exam}
